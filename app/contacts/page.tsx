...
export default function ContactsPage() {
  ...
  async function addContact(event: FormEvent<HTMLFormElement>) {
    ...
    setNotice("Contact added successfully."); setOpen(false); setSelectedConstituency(""); event.currentTarget.reset(); await load();
  }
