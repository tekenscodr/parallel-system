...
const POSITIONS_BY_LEVEL: Record<string, string[]> = {
  ...
  Region: [
    "Regional Chairman",
    "1st Regional Vice-Chairman",
    "2nd Regional Vice-Chairman",
    "Regional Secretary",
    ...
    "Regional Electoral Affairs Officer",
    "Regional Legal Representative Officer",
    "Regional PWD Officer",
    "Regional Special Duties Officer",
  ],
  Constituency: [
    "Chairperson",
    "1st Vice-Chairperson",
